...
// --- Utilitaire Base64 ---
const filesToBase64 = (files)=>Promise.all(files.map((file)=>new Promise((resolve, reject)=>{
            const reader = new FileReader();
            reader.readAsDataURL(file);
            reader.onload = ()=>resolve(reader.result);
            reader.onerror = (err)=>reject(err);
        })));
// --- Utilitaire pour l'affichage d'image ---
...
function ProductsTab({ products: initialProducts, onDeleteProduct }) {
    ...
    // --- Ajouter produit avec ImageKit Base64 ---
    const handleAdd = async ()=>{
        if (!addForm.nom || !addForm.prix || !addForm.categoryId || addImages.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Champs obligatoires manquants ou aucune image");
            return;
        }
        setLoading(true);
        try {
            const imagesBase64 = await filesToBase64(addImages.filter((i)=>i.file).map((i)=>i.file));
            const imagesPayload = imagesBase64.map((base64, idx)=>({
                    file: base64,
                    color: addImages[idx].color,
                    size: addImages[idx].size,
                    stock: Number(addImages[idx].stock) || 0
                }));
            const payload = {
                ...addForm,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Produit ajouté !");
            setAddForm({
                nom: "",
                description: "",
                prix: "",
    ...
    const handleUpdate = async ()=>{
        ...
        setLoading(true);
        try {
            // Filtrer les images qui ont un File (pas null)
            const validImages = editImages.filter((i)=>i.file !== null);
            const newFiles = validImages.map((i)=>i.file);
            const imagesBase64 = await filesToBase64(newFiles);
            const imagesPayload = imagesBase64.map((base64, idx)=>({
                    file: base64,
                    color: validImages[idx].color,
                    size: validImages[idx].size,
                    stock: Number(validImages[idx].stock) || 0
                }));
            const payload = {
                ...editForm,
    ...
    const removeImage = (index, isEdit)=>{
        ...
        if (img?.preview.startsWith("blob:")) URL.revokeObjectURL(img.preview);
        isEdit ? setEditImages((prev)=>prev.filter((_, i)=>i !== index)) : setAddImages((prev)=>prev.filter((_, i)=>i !== index));
    };
    // --- Handlers pour fichiers et métadonnées d'images ---
    ...
    const updateAddImageMeta = (index, key, value)=>{
        setAddImages((prev)=>prev.map((img, i)=>i === index ? {
                    ...img,
                    [key]: value
                } : img));
    };
    const updateEditImageMeta = (index, key, value)=>{
        setEditImages((prev)=>prev.map((img, i)=>i === index ? {
                    ...img,
                    [key]: value
                } : img));
    };
...
function SalonsTab({ users, salons: externalSalons = [], onSalonCreated }) {
    ...
    ;
    const managers = users.filter((u)=>u.role === "gerant" || u.role === "admin");
    ...
    const handleAddSalon = async ()=>{
        ...
        try {
            const res = await fetch("/api/createsalons", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: salons.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Aucun salon enregistré pour le moment"
                }, void 0, false, {
                    fileName: "[project]/components/superadmin/salons-tab.tsx",
                    lineNumber: 214,
                    columnNumber: 11
                }, this) : salons.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                            className: "p-6",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                                                    ...
                                                    children: s.status === "active" ? "Actif" : "Inactif"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/superadmin/salons-tab.tsx",
                                                    lineNumber: 225,
                                                    columnNumber: 23
...
//# sourceMappingURL=_ff40ee4b._.js.map