...
function SuperAdminDashboard() {
            ...
            const fetchSalons = {
                "SuperAdminDashboard.useEffect.fetchSalons": async ()=>{
                    ...
                    try {
                        ...
                        // 🔥 Convertir les salons du backend → format attendu par le front
    ...
    const handleAddSalon = async (newSalon)=>{
        try {
            ...
            const res = await fetch("http://localhost:3500/api/admin/create-salon", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
            ...
            // Convertir le status en type strict pour TypeScript
            const createdSalon = {
                ...data.salon,
            ...
            toast({
                title: "Erreur",
                description: "Erreur lors de l'ajout du salon"
            });
        }
    };
...
//# sourceMappingURL=_46075ce7._.js.map