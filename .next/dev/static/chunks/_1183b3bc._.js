...
function AccountPage() {
    ...
    // PAR ÇA (le hook safe qui attend l'hydratation) :
    const { user, isAuthenticated, isLoading } = useAuthSafe();
    const { logout, updateProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])() // on garde juste ces deux-là du store normal
    ;
    ...
    // Synchro parfaite avec le store
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(AccountPage, "d5X3QGxzaez+12h3evAMNPNXuE4=", true, function() {
    return [
...
//# sourceMappingURL=_1183b3bc._.js.map