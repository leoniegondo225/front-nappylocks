...
const useAuthSafe = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAuthSafe.useEffect": ()=>{
            // On regarde directement si le store a déjà des données
            const check = {
                "useAuthSafe.useEffect.check": ()=>{
                    const state = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState();
            ...
            const unsub = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].subscribe({
                "useAuthSafe.useEffect.unsub": ()=>{
                    check();
                }
            }["useAuthSafe.useEffect.unsub"]);
            // Fallback de sécurité (max 1 seconde)
            const timeout = setTimeout({
                "useAuthSafe.useEffect.timeout": ()=>{
                    setIsHydrated(true);
                    unsub();
                }
            }["useAuthSafe.useEffect.timeout"], 1000);
            return ({
                "useAuthSafe.useEffect": ()=>{
                    unsub();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuthSafe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useAuthSafe.ts [app-client] (ecmascript)"); // ← AJOUTE CETTE LIGNE
...
_s(Header, "8wekWlQCZF3EbijNLp/a7VdbX5Q=", true, function() {
    return [
...
const products = [
    ...
    },
    {
        ...
        price: 22,
        image: "/products/curl-gel.jpg",
        category: "produits-cheveux",
        inStock: true
    },
    {
        id: "4",
        name: "Spray Hydratant Leave-In",
        price: 12,
        image: "/products/moisturizer-spray.jpg",
        category: "produits-cheveux",
        inStock: true
    },
    {
        ...
        price: 8,
        image: "/satin-bonnet-hair-protection.jpg",
    ...
    },
    {
        ...
        price: 14,
        image: "/detangling-brush-natural-hair.jpg",
        category: "accessoires",
        inStock: true
    },
    {
        ...
        price: 10,
        image: "/wooden-afro-pick-comb.jpg",
        category: "accessoires",
        inStock: true
    },
    {
    ...
    },
    {
        ...
        price: 9,
        image: "/african-black-soap.jpg",
        category: "produits-peau",
        inStock: true
    },
    {
        id: "10",
    ...
    },
    {
        ...
        price: 20,
        image: "/shea-body-scrub.jpg",
        category: "produits-peau",
        inStock: false
    },
    {
        id: "12",
        name: "Shampoing Enfant Doux",
        price: 13,
        image: "/gentle-kids-shampoo.jpg",
        category: "enfants",
        inStock: true
    },
    {
        id: "13",
        name: "Démêlant Enfant",
        price: 11,
        image: "/kids-detangler-spray.jpg",
        category: "enfants",
        inStock: true
    },
    {
...
const categories = [
    ...
    {
        value: "produits-cheveux",
        label: "Produits Cheveux"
    },
    {
        value: "accessoires",
        label: "Accessoires"
...
function HomePage() {
    ...
    //   // Redirection protégée uniquement après hydratation
    // useEffect(() => {
        ...
        "HomePage.useMemo[filteredProducts]": ()=>{
            ...
            if (selectedCategory !== "all") {
                filtered = filtered.filter({
                    "HomePage.useMemo[filteredProducts]": (p)=>p.category === selectedCategory
                }["HomePage.useMemo[filteredProducts]"]);
            }
            if (searchQuery) {
                filtered = filtered.filter({
                    "HomePage.useMemo[filteredProducts]": (p)=>p.name.toLowerCase().includes(searchQuery.toLowerCase())
                }["HomePage.useMemo[filteredProducts]"]);
            }
            const sorted = [
                ...filtered
            ...
            switch(sortBy){
                case "price-asc":
                    sorted.sort({
                        "HomePage.useMemo[filteredProducts]": (a, b)=>a.price - b.price
                    }["HomePage.useMemo[filteredProducts]"]);
                    break;
                case "price-desc":
                    sorted.sort({
                        "HomePage.useMemo[filteredProducts]": (a, b)=>b.price - a.price
                    }["HomePage.useMemo[filteredProducts]"]);
                    break;
                case "name":
                    sorted.sort({
                        "HomePage.useMemo[filteredProducts]": (a, b)=>a.name.localeCompare(b.name)
                    }["HomePage.useMemo[filteredProducts]"]);
                    break;
            }
            return sorted;
    ...
    // Pendant le chargement → on affiche rien ou un loader
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm md:text-base text-muted-foreground max-w-2xl mx-auto text-pretty",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: categories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `px-4 py-2.5 rounded-full text-sm font-medium whitespace-nowrap transition-all ${selectedCategory === cat.value ? "bg-gold text-gold-foreground shadow-lg shadow-gold/20" : "bg-muted text-foreground hover:bg-muted/80"}`,
                                        children: cat.label
                                    }, cat.value, false, {
                                        fileName: "[project]/app/page.tsx",
                                        lineNumber: 362,
                            ...
                            filteredProducts.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-muted-foreground",
                                        children: "Essayez une autre recherche ou catégorie"
                                    }, void 0, false, {
                                        fileName: "[project]/app/page.tsx",
                                        lineNumber: 467,
                                        columnNumber: 15
...
_s(HomePage, "F76F0rx+Y4o3KJw4/O62pMwJ92E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuthSafe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthSafe"],
...
//# sourceMappingURL=_06b7c7df._.js.map